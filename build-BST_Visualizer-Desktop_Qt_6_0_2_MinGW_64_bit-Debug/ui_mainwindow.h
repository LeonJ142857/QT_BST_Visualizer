...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        insertButton->setCursor(QCursor(Qt::ArrowCursor));
        ...
        deleteButton->setCursor(QCursor(Qt::ArrowCursor));
        ...
        searchButton->setCursor(QCursor(Qt::ArrowCursor));
        ...
        TraversalLabel_2->setMinimumSize(QSize(100, 0));
        ...
        BFTButton->setCursor(QCursor(Qt::ArrowCursor));
        BFTButton->setCheckable(false);
        ...
        PreOrderButton->setCursor(QCursor(Qt::ArrowCursor));
        PreOrderButton->setCheckable(false);
        ...
        InOrderButton->setCursor(QCursor(Qt::ArrowCursor));
        InOrderButton->setCheckable(false);
        ...
        PostOrderButton->setCursor(QCursor(Qt::ArrowCursor));
        PostOrderButton->setAutoFillBackground(false);
        PostOrderButton->setCheckable(false);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        TraversalLabel_2->setText(QCoreApplication::translate("MainWindow", "Generate", nullptr));
        tree_size->setPlaceholderText(QCoreApplication::translate("MainWindow", "Nodes count", nullptr));
